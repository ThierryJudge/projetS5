...
#define RADIO_TX                p28 /* TODO: specify your setup's Serial TX pin connected to the XBee module DIN pin */
#define RADIO_RX                p27 /* TODO: specify your setup's Serial RX pin connected to the XBee module DOUT pin */
...
#define RADIO_RESET             p21 /* TODO: specify your setup's GPIO (output) connected to the XBee module's reset pin */
